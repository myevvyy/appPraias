...
*/}
            ...
            <View style={styles.contentContainer}>
                ...
                <Text style={styles.description}>
                    Maragogi é um município localizado no litoral norte de Alagoas, conhecido como o "Caribe Brasileiro" devido às suas águas cristalinas, piscinas naturais e paisagens paradisíacas. Situado a 125 km de Maceió e próximo ao Recife, faz parte da Costa dos Corais e é um dos principais destinos turísticos do estado, atrás apenas da capital alagoana.
                </Text>
                {/* Imagem do Mapa */}
                <Image
